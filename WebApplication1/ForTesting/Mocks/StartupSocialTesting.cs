...
using WebApplication1.Mocks.Common;
using WebApplication1.Mocks.Facebook;
using WebApplication1.Mocks.Google;
using WebApplication1.Mocks.MicrosoftAccount;
using WebApplication1.Mocks.Twitter;
...
namespace WebApplication1
{
    public class StartupSocialTesting
    {
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //Populates the WebApplication1 sample data
            SampleData.InitializeWebApplication1DatabaseAsync(app.ApplicationServices).Wait();
        }
    }
}
