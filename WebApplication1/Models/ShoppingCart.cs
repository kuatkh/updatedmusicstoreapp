...
namespace WebApplication1.Models
{
    public class ShoppingCart
    {
        ...
        private ShoppingCart(WebApplication1Context dbContext, string id)
        {
            _dbContext = dbContext;
            _shoppingCartId = id;
        }

        public static ShoppingCart GetCart(WebApplication1Context db, HttpContext context) 
            => GetCart(db, GetCartId(context));

        public static ShoppingCart GetCart(WebApplication1Context db, string cartId)
