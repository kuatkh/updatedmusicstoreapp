...
namespace WebApplication1.Models
{
    public static class SampleData
    {
        ...
        public static async Task InitializeWebApplication1DatabaseAsync(IServiceProvider serviceProvider, bool createUsers = true)
        {
            using (var serviceScope = serviceProvider.CreateScope())
            {
                var scopeServiceProvider = serviceScope.ServiceProvider;
                var db = scopeServiceProvider.GetService<WebApplication1Context>();
            ...
            where TEntity : class
        {
            ...
            {
                var db = serviceScope.ServiceProvider.GetService<WebApplication1Context>();
